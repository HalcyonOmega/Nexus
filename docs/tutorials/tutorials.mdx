...
description: "Learn how to use Nexus to automate workflows through practical examples"
icon: "play"
---
...
<CardGroup cols={3}>
  <Card
    ...
    href="https://github.com/VRSEN/nexus-lab/tree/main/WebDevCrafters"
    icon="laptop-code"
    iconType="duotone"
  >
  ...
  <Card
    ...
    href="https://github.com/VRSEN/nexus-lab/tree/main/CodeGuardiansAgency"
    icon="shield-halved"
    iconType="duotone"
  >
