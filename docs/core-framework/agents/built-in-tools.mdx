...
description: "Learn how to use built-in tools in Nexus."
icon: "wrench"
---

Each agent in Nexus also with some built-in tools inherited from [OpenAI Assistants API](https://platform.openai.com/docs/api-reference/assistants/createAssistant#assistants-createassistant-tools).
...
```python
from nexus.tools import CodeInterpreter
