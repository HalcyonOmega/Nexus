...
By default, Nexus keeps the state of your agents in a special `settings.json` file. If you would like to use a different file path for settings, you can specify a `settings_path` parameter:
