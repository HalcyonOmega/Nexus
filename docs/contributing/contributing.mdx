...
description: "Learn how to contribute to Nexus"
icon: "code-fork"
---

We welcome contributions to Nexus! By contributing, you help improve the framework for everyone. Here's how you can get involved:
...
<Step title="Fork the Repository" icon="code-branch" iconType="solid">
  Fork the Nexus repository on GitHub to your own account.
</Step>
