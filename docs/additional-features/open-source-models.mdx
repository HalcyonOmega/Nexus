...
description: "Utilize open-source models with Nexus."
icon: "code-fork"
---
...
>
  ...
  [notebook](https://github.com/VRSEN/nexus/blob/main/notebooks/os_models_with_astra_assistants_api.ipynb) and [official examples](https://github.com/datastax/astra-assistants-api/tree/main/examples/python/nexus).
</Card>
...
<Card title="Open Assistant API" icon="users" iconType="solid" href="https://github.com/MLT-OSS/open-assistant-api">
  ...
  [here](https://github.com/VRSEN/nexus-lab/tree/main/OpenSourceSwarm).
</Card>
...
To utilize your agency in Gradio, apply a specific non-streaming `demo_gradio` method from the [nexus-lab](https://github.com/VRSEN/nexus-lab/blob/main/OpenSourceSwarm/demo_gradio.py) repository:
...
**For complete examples, see the [implementation notebook](https://github.com/VRSEN/nexus/blob/main/notebooks/os_models_with_astra_assistants_api.ipynb) and [official Astra Assistants examples](https://github.com/datastax/astra-assistants-api/tree/main/examples/python/nexus).**

## General Instructions

To use nexus with any other projects that mimic the Assistants API, generally, you need to follow these steps:

<Steps>

<Step title="Install the previous version of nexus as most projects are not yet compatible with streaming and Assistants V2:">
```bash
...
If you successfully integrate other projects with nexus, please share your experience through an issue or pull request.
