...
<Info>
In Nexus, threads are stored in a dictionary that contains all conversation thread IDs, including those between your agents.
</Info>
...
<Card
  ...
  href="https://github.com/vrsen-ai-solutions/nexus-tools-template"
  icon="fire"
  iconType="duotone"
>
  Click here to open the template and follow the instructions provided.
