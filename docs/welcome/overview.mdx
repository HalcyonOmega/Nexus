---
title: "Overview"
description: "Welcome to **Nexus**, an open-source agent orchestration framework built on top of the latest [OpenAI Assistants API](https://platform.openai.com/docs/assistants/overview/agents)."
icon: "globe"
---
...
<CardGroup cols={2}>
  ...
  <Card title="State Management" icon="database">
    Nexus efficiently manages the state of your assistants on OpenAI, maintaining it in a special settings.json file.
  </Card>
  <Card title="Deployable in Production" icon="rocket">
    Nexus is designed to be reliable and easily deployable in production environments.
  </Card>
</CardGroup>
