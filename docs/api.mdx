---
title: "API Reference"
description: "Gain a deeper understanding of the core classes and methods available in Nexus."
icon: "book"
---
...
The Agent class is the core component of Nexus that represents an AI assistant. Each agent has specific capabilities, tools, and can process files and instructions.
...
def from_langchain_tools(tools: List) -> List[Type[BaseTool]]:
    """
    Convert LangChain tools into Nexus tools.
