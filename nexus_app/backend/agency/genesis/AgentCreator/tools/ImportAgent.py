...
class ImportAgent(BaseTool):
    """
    This tool imports an existing agent from nexus framework. Please make sure to first use the GetAvailableAgents tool to get the list of available agents.
    """
