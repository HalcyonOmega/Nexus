...
from tools import BaseTool, CodeInterpreter, FileSearch
from tools.send_message import SendMessage, SendMessageBase
from user import User
from util.errors import RefusalError
from util.files import get_file_purpose, get_tools
...
class Agency:
    def __init__(
        ...
        if self.async_mode == "threading":
            from tools.send_message import SendMessageAsyncThreading
