    ...
    with open(path + class_name + ".py", "w") as f:
        f.write(
            agent_template.format(
                ...
                code_interpreter_import="from nexus.tools import CodeInterpreter"
                if code_interpreter
                else "",
            )
        )
...
agent_template = """from nexus.agents import Agent
...
example_tool_template = """from nexus.tools import BaseTool
