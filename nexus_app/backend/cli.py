...
from util.helpers import list_available_agents
...
def main():
    ...
    if args.command == "create-agent-template":
        from util.cli.create_agent_template import create_agent_template
        ...
        if args.openai_key:
            from backend import set_openai_key

            set_openai_key(args.openai_key)

        from agency.genesis import GenesisAgency
